...
public class World {
    ...
    /**
     * Creates a new Wumpus World. The Wumpus World works with any size 4 or
     * larger, but only size 4 is supported by the GUI.
     *
    ...
    /**
     * Checks if a square has a breeze. Returns false if the position is
    ...
    /**
     * Checks if a square has a stench. Returns false if the position is
     * invalid, or if the square is unknown.
     *
     * @param x X position
     * @param y Y position
    ...
    /**
     * Checks if a square has glitter. Returns false if the position is invalid,
     * or if the square is unknown.
     *
     * @param x X position
     * @param y Y position
    ...
    /**
     * Checks if a square has a pit. Returns false if the position is invalid,
     * or if the square is unknown.
     *
     * @param x X position
     * @param y Y position
    ...
    /**
     * Removes the Wumpus (and Stench) from the Wumpus World. Used when the
     * Wumpus has been hit by the arrow.
     */
